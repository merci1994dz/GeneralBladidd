...
import { Plus, Settings, Heart, Tv, Search } from "lucide-react";
...
export default function Home() {
  ...
  const onCategoryChangeWrapper = (category: string) => {
  ...
  return (
    <div className="min-h-screen bg-tv-dark">
      ...
      <div className="bg-tv-gradient px-6 pt-4 pb-2 border-b border-tv-accent/30">
        <div className="relative mb-4">
          <Search className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
          <Input
            type="text"
            placeholder="ابحث عن قناة..."
            className="bg-tv-surface border-tv-accent/30 text-white pr-10 text-right arabic-text"
            value={searchQuery}
        ...
        <CategoryTabs 
          ...
          onCategoryChange={onCategoryChangeWrapper}
        />
      </div>
